...
class SignalFusion:
    ...
    def __init__(self, method: str = "weighted_average", use_llm_summary: bool = False):
        """
        Initialize signal fusion.

        Args:
            method: Fusion method (weighted_average, confidence_weighted)
            use_llm_summary: Whether to use LLM for evidence summarization (disabled for ADK)
        """
        self.method = method
        self.use_llm_summary = False  # Disabled - agents already use Gemini
